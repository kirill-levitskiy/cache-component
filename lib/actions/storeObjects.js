...
exports.process = async function processAction(msg, cfg) {
  ...
  this.logger.info(`Maester config: ${token} ${uri}`);
  ...
  this.logger.info(`Create bucket result: ${JSON.stringify(createdBucket)}`);
  ...
  this.logger.info(`Emitting data: ${JSON.stringify(result)}`);
